...
public final class RGBColor implements Cloneable, java.io.Serializable
{
	 ...
	 */
	public static final RGBColor Black = new RGBColor(0f, 0f, 0f, 1f);
	/**
	 * The color purple (0,0,0).
	 */
	public static final RGBColor Purple = new RGBColor(1f, 0f, 1f, 1f);
	/**
	 * The color white (1,1,1).
	 */
	public static final RGBColor White = new RGBColor(1f, 1f, 1f, 1f);
	/**
	 * The color gray (.2,.2,.2).
	 */
	public static final RGBColor DarkGray = new RGBColor(0.2f, 0.2f, 0.2f, 1.0f);
	/**
	 * The color gray (.5,.5,.5).
	 */
	public static final RGBColor Gray = new RGBColor(0.5f, 0.5f, 0.5f, 1.0f);
	/**
	 * The color gray (.8,.8,.8).
	 */
	public static final RGBColor LightGray = new RGBColor(0.8f, 0.8f, 0.8f, 1.0f);
	/**
	 * The color red (1,0,0).
	 */
	public static final RGBColor Red = new RGBColor(1f, 0f, 0f, 1f);
	/**
	 * The color green (0,1,0).
	 */
	public static final RGBColor Green = new RGBColor(0f, 1f, 0f, 1f);
	/**
	 * The color blue (0,0,1).
	 */
	public static final RGBColor Blue = new RGBColor(0f, 0f, 1f, 1f);
	/**
	 * The color yellow (1,1,0).
	 */
	public static final RGBColor Yellow = new RGBColor(1f, 1f, 0f, 1f);
	/**
	 * The color magenta (1,0,1).
	 */
	public static final RGBColor Magenta = new RGBColor(1f, 0f, 1f, 1f);
	/**
	 * The color cyan (0,1,1).
	 */
	public static final RGBColor Cyan = new RGBColor(0f, 1f, 1f, 1f);
	/**
	 * The color orange (251/255, 130/255,0).
	 */
	public static final RGBColor Orange = new RGBColor(251f / 255f, 130f / 255f, 0f, 1f);
	/**
	 * The color brown (65/255, 40/255, 25/255).
	 */
	public static final RGBColor Brown = new RGBColor(65f / 255f, 40f / 255f, 25f / 255f, 1f);
	/**
	 * The color pink (1, 0.68, 0.68).
	 */
	public static final RGBColor Pink = new RGBColor(1f, 0.68f, 0.68f, 1f);
	/**
	 * The black color with no alpha (0, 0, 0, 0).
	 */
	public static final RGBColor BlackNoAlpha = new RGBColor(0f, 0f, 0f, 0f);
	/**
	 ...
	 * @param g
	 *            The green component of this <code>ColorRGBA</code>.
	 * @param b
	 *            The blue component of this <code>ColorRGBA</code>.
	 * @param a
	 *            The alpha component of this <code>ColorRGBA</code>.
	 */
	 ...
	 * @return this
	 */
	public RGBColor set(float r, float g, float b, float a)
	{
		this.r = r;
		this.g = g;
		this.b = b;
	 ...
	 * 
	 * @param rgba
	 *            The color to set this <code>ColorRGBA</code> to.
	 * @return this
	 */
	public RGBColor set(RGBColor rgba)
	{
		if (rgba == null)
		{
			r = 0;
	 ...
	 */
	public void interpolate(RGBColor finalColor, float changeAmnt)
	{
		r = (1 - changeAmnt) * r + changeAmnt * finalColor.r;
		g = (1 - changeAmnt) * g + changeAmnt * finalColor.g;
		b = (1 - changeAmnt) * b + changeAmnt * finalColor.b;
		a = (1 - changeAmnt) * a + changeAmnt * finalColor.a;
	}
	 ...
	 */
	public void interpolate(RGBColor beginColor, RGBColor finalColor, float changeAmnt)
	{
		...
		a = (1 - changeAmnt) * beginColor.a + changeAmnt * finalColor.a;
	}
	...
	{
		final RGBColor rVal = new RGBColor(0, 0, 0, 1);
	...
	{
		return new RGBColor(c.r * r, c.g * g, c.b * b, c.a * a);
	}
	 ...
	 */
	public RGBColor mult(float scalar)
	{
		return new RGBColor(scalar * r, scalar * g, scalar * b, scalar * a);
	}
	 ...
	 * @return this*c
	 */
	public RGBColor multLocal(float scalar)
	{
		r *= scalar;
		g *= scalar;
		b *= scalar;
	 ...
	 * 
	 * @param floats
	 *            The <code>float</code> array to take this
	 *            <code>ColorRGBA</code>. If null, a new <code>float[4]</code>
	 *            is created.
	 ...
	 * 
	 * @param color
	 *            The integer ARGB value used to set this <code>ColorRGBA</code>
	 *            .
	 */
